...
printf "There are modifiers you can add at the end (like 'g' for global, or 'i' for case-insensitive).\n"
...
printf "To recap, BREs require you to escape certin regex operators (e.g., capture groups).\n"
...
printf "Now let's change it back with sed.\n"
    ...
    cat ./examples/hello.c
    sed -i -E 's/friend/world/g' ./examples/hello.c
    cat ./examples/hello.c
...
printf "Then your file is successfully restored.\n"
...
printf "If we wanted to use perl to achieve this functionality, we'd use something like this:\n"
...
printf "That's how you can delete lines with perl.\n"
