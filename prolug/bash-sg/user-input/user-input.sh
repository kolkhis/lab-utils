...
printf "We can just add another condition to check that the first character is a dash (-).\n"
...
printf "This condition uses the regex operator (=~) to check that the first character is dash (-).\n"
